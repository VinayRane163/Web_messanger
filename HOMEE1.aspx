<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HOMEE1.aspx.cs" Inherits="Web_Messenger.HOMEE1" %>
...
<section class="mainApp">
	...
	<div class="rightPanel">
		...
		<div class="replyBar">
			<button class="attach">
                <i class="fa fa-paperclip" aria-hidden="true">nega</i>

			</button>
			
            <asp:Textbox Class="replyMessage" runat="server" type="search" placeholder="Type your message..." ></asp:Textbox>
